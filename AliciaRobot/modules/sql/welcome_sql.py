...
DEFAULT_WELCOME = "Hey  {first}, We are so excited about having you on our team!"
DEFAULT_GOODBYE = "Goodbyes are not forever, are not the end; it simply means I'll miss you until we meet again."
