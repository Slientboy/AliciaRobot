...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import AliciaRobot.events

        path = Path(f"AliciaRobot/modules/{shortname}.py")
        name = "AliciaRobot.modules.{}".format(shortname)
        ...
        mod.AliciaRobot = AliciaRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["AliciaRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "AliciaRobot/modules/*.py"
